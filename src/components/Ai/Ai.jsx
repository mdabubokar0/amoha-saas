...
const Ai = () => {
  return (
    <div
      id="diseases"
      className="mt-[70px] px-[10px] lg:px-9 m-auto 2xl:w-[1366px] bg-[#b7e9f7] text-font1 text-center py-1 rounded-3xl"
    >
      <div className="my-10">
        <motion.div
        ...
        >
          <div className="mb-5 text-2xl font-heading font-semibold">
        ...
        <div className="flex flex-col xl:flex-row gap-2 justify-between relative">
          <motion.div
            ...
            className="bg-[#D9FFDB] w-auto h-[250] xl:w-[420px] lg:h-[320px] rounded-[30px] pt-5 p-2 xl:p-5 [--x-from:0px] [--x-to:0px] xl:[--x-from:100px] xl:[--x-to:0px] [--y-from:-30px] [--y-to:0px] xl:[--y-from:100px] xl:[--y-to:0px] expand"
          >
            <Aicards
